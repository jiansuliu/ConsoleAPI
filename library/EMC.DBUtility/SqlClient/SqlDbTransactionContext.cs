...
namespace EMC.DbUtility.SqlClient
{
  ...
  /// </summary>
  public class SqlDbTransactionContext : DbTransactionContextBase<SqlDbExecutor, MySqlTransaction>
  {
    ...
    private class SqlDbExecutorWithTransaction : SqlDbExecutor
    {
      ...
      protected sealed override async Task<IAsyncDbExecuteContext> ExecuteAsync( MySqlCommand command, CancellationToken token, IDbTracing tracing = null )
      {
        try
        {
